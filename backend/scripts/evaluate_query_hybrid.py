...
POSITIVE_QUERIES = [
    ...
    # 지목됐으나 검증 결과 기각한다. 나이키 라이즈의 실제 search_facets는
    # {"styles": ["캐주얼"]} 뿐이다(subcategory=캐주얼·스트리트에서 파생). "캐주얼"은
    ...
    # 확인하는 축은 intents인데, Phase 1 vocabulary는 styles·cuisines만 채택했고
    # intents는 스키마 미확정으로 오버레이에 없다(conversational-discovery.md 12절).
