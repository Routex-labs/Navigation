...
| PO-ICHMHCnSB9385 | 뉴마핏 | 스포츠·아웃도어 | 미확인 | - | ehyundai.com 층별안내(WebFetch)에서 더현대서울 4F "스포츠·아웃도어" 섹션에 등재된 것은 확인했으나, 실제 취급 품목(신발 포함 여부)은 5분 내 확인 안 됨. 동명의 유산소운동 코칭 웨어러블 기기 회사(neumafit.co.kr)와 혼동 소지가 있어 신발 판매 여부 불명 |  | P3-1-golf-sports.md |
| PO-uBMRwQaU-2839 | 티노5 | 스포츠·아웃도어 | 미확인 | - | tino5.com, ehyundai.com 층별안내("골프" 섹션 등재) — 트랙맨 데이터 기반 클럽 피팅·판매 서비스로 확인되나, 신발 취급 여부는 5분 내 확인 안 됨 |  | P3-1-golf-sports.md |
| PO-gjLPXNKVA4359 | OIC (OIOI COLLECTION)/ 시스티나 | 캐주얼·스트리트 | 미확인 | - | 무신사 OIOI COLLECTION 검색: "상품 카테고리는 신발 포함" 안내가 있으나 실제 상시 슈즈 상품은 직접 확인 안 됨 | 시스티나(컨템포러리 여성복, 신발 근거 없음)와 병기된 매장이라 판정 보수적으로 처리 | P3-3-casual.md |
| PO-IYdIE24Hx7456 | OIC(OIOI COLLECTION) | 캐주얼·스트리트 | 미확인 | - | 상동 | 상동 | P3-3-casual.md |
| PO-FkgbiRslv1294 | PEER | 캐주얼·스트리트 | 미확인 | - | 무신사·검색에서 동일/유사명 브랜드(피어리스니스, 디어피어 등)만 발견, 정확한 "PEER" 매장 특정 실패 | 브랜드 자체를 확정하지 못함 — 5분 내 근거 없음 | P3-3-casual.md |
| PO-G_0ivBDOl1694 | 구호플러스 | 캐주얼·스트리트 | 미확인 | - | ssfshop/무신사 검색 결과 슈트·재킷·코트 등 의류만 확인, 신발 상품 없음 | 컨템포러리 정장 브랜드 성격 — 신발 근거를 못 찾음 | P3-3-casual.md |
| PO-IZBfLiwkg3640 | 나이스웨더 | 캐주얼·스트리트 | 미확인 | - | niceweather.co.kr·무신사: 가방·모자·의류만 확인, 신발 카테고리 언급 없음 | '문화적 소비 편집매장' 콘셉트지만 신발 근거 없음 | P3-3-casual.md |
| PO-GD_P0mEqu3016 | 노매뉴얼 | 캐주얼·스트리트 | 미확인 | - | 무신사: 아우터·상의·가방·"NM SHOE POUCH"(신발 보관 파우치)만 확인, 신발 자체는 없음 | 신발 파우치는 액세서리이지 신발이 아님 — 보수적으로 미확인 | P3-3-casual.md |
| PO-rO3czsGyS6587 | 노매뉴얼 코이세이오 | 캐주얼·스트리트 | 미확인 | - | 상동(노매뉴얼 근거) + 코이세이오는 신발 취급 확인되나 병기 매장이라 상위 브랜드 기준 보수적 판정 | 두 브랜드 병기 매장 — 노매뉴얼 근거 부족으로 미확인 처리 | P3-3-casual.md |
| PO-Pm38PkFGa6936 | 더치랩 | 캐주얼·스트리트 | 미확인 | - | 검색에서 브랜드 특정 실패(동명 이업종 다수 검색됨) | 5분 내 정확한 브랜드 확인 및 신발 근거 못 찾음 | P3-3-casual.md |
| PO-GzmAvXGsO8350 | 데우스 엑스 마키나 | 캐주얼·스트리트 | 미확인 | - | 위키백과·29CM: 모터사이클·서핑 기반 라이프스타일 의류 브랜드로 소개, 신발 언급 없음 | 의류·바이크 커스텀 중심 브랜드, 신발 근거 부족 | P3-3-casual.md |
| PO-TJYkqBdgk7497 | 드파운드 | 캐주얼·스트리트 | 미확인 | - | 무신사(DEPOUND): 볼캡·드레스·후드티·가방만 확인, 신발 상품 없음 | 의류·잡화 중심, 신발 근거 없음 | P3-3-casual.md |
| PO-2iPQ-1iOB6648 | 론론 | 캐주얼·스트리트 | 미확인 | - | 무신사(RONRON): 셋업·스웨트셔츠 등 의류만 확인, 신발 언급 없음 | 신발 근거 없음 | P3-3-casual.md |
| PO-y76w4Tqi78056 | 마뗑킴 | 캐주얼·스트리트 | 미확인 | - | 무신사 브랜드관·슈즈 페스티벌(200여 브랜드 참여) 기사에서 마뗑킴 단독 신발 상품 직접 확인 안 됨 | 의류 중심 브랜드로 보이며 상시 슈즈 카테고리 확인 실패 | P3-3-casual.md |
| PO-0-bgiJ5NN1975 | 마리떼프랑소와저버/ LMC | 캐주얼·스트리트 | 미확인 | - | 무신사 브랜드관 확인했으나 두 브랜드 모두 신발 상품 구체 확인 안 됨 | LMC는 모자·의류 중심으로 알려져 신발 근거 약함 | P3-3-casual.md |
| PO-y3sRxasGj4856 | 망고매니플리즈 | 캐주얼·스트리트 | 미확인 | - | 무신사: "특정 신발 상품도 포함되어 있다"는 요약이 나왔으나 상시 카테고리 여부 직접 확인 못 함 | 팬츠·상의 위주 브랜드, 슈즈는 부정기적일 가능성 — 보수적으로 미확인 | P3-3-casual.md |
| PO-0iSHOEShr4616 | 베흐트 | 캐주얼·스트리트 | 미확인 | - | 무신사(VERTE): 목걸이·반지·귀걸이 등 주얼리 중심 상품만 확인, 신발 언급 없음 | 주얼리 브랜드 성격이 강함 — 신발 근거 없음 | P3-3-casual.md |
| PO-uYfnRRWks3094 | 산산기어 | 캐주얼·스트리트 | 미확인 | - | 무신사·나무위키(SANSAN GEAR): 티셔츠·후드·팬츠 등 의류만 확인, 신발 언급 없음 | 스트리트 의류 중심, 신발 근거 없음 | P3-3-casual.md |
| PO-oLu9QD5RA0398 | 세터 | 캐주얼·스트리트 | 미확인 | - | 검색에서 정확한 "세터" 브랜드 특정 실패(유사 발음 브랜드만 다수 검색됨) | 5분 내 브랜드 확정 및 신발 근거 못 찾음 | P3-3-casual.md |
| PO-YnEnswOj_2863 | 스미스앤레더 | 캐주얼·스트리트 | 미확인 | - | smithleather.kr: "프리미엄 천연 가죽" 커스텀 상품 중심으로 소개, 신발 언급 없음 | 가죽 액세서리·주문제작 중심 브랜드로 보임 | P3-3-casual.md |
| PO-7fUfWWCxv5071 | 시스티나 | 캐주얼·스트리트 | 미확인 | - | 무신사(SISTINA): 트렌치코트·니트·재킷 등 의류만 확인, 신발 언급 없음 | 컨템포러리 여성복(아우터 중심) 브랜드, 신발 근거 없음 | P3-3-casual.md |
| PO-WP6E13oBM5328 | 시에 | 캐주얼·스트리트 | 미확인 | - | sie-official.kr 확인했으나 신발 관련 정보 못 찾음, 유사 브랜드(시오르·지이크 등)와 혼동 우려 | 브랜드 특정 및 신발 근거 모두 불확실 | P3-3-casual.md |
| PO-dtC0g64OW8951 | 시티브리즈 | 캐주얼·스트리트 | 미확인 | - | 무신사(CITYBREEZE): 후디·니트·자켓 등 의류만 확인, 신발 언급 없음 | 니트웨어 중심 브랜드, 신발 근거 없음 | P3-3-casual.md |
| PO-R03Lq2KLr5175 | 이미스 | 캐주얼·스트리트 | 미확인 | - | 무신사·29CM(EMIS): 가방·모자·수영복 등 확인, 신발 상품 직접 확인 안 됨 | 잡화·의류 중심 브랜드로 보임 | P3-3-casual.md |
| PO-oFH1Mqwg10118 | 인사일런스 | 캐주얼·스트리트 | 미확인 | - | 무신사(INSILENCE): 자켓·다운·스웨트셔츠 등 확인, 신발은 카테고리 요약에만 언급되고 실제 상품 미확인 | 미니멀 아우터 중심 브랜드 — 보수적으로 미확인 | P3-3-casual.md |
| PO-3JR50JIg47995 | 틸아이다이 | 캐주얼·스트리트 | 미확인 | - | 무신사(TILL I DIE): 아우터·니트·스웨트셔츠만 확인, 신발 언급 없음 | 니트·아우터 중심 브랜드, 신발 근거 없음 | P3-3-casual.md |
| PO-8ElPuiRkf3314 | SJSJ | 컨템포러리 | 미확인 | — | thehandsome.com SJSJ 브랜드 페이지 확인했으나 검색 결과가 여성의류(원피스·자켓·니트) 위주였고 신발 상품을 확인하지 못함 | 한섬 브랜드. 더한섬닷컴에서 SJSJ 카테고리 직접 열람 필요 | P3-4-contemporary.md |
| PO-iOkNmGeMj3233 | 노이스 | 컨템포러리 | 미확인 | — | 검색 결과가 "NOIZE"(캐나다 아웃도어 패딩)·"NOICE" 등으로 이름이 갈려 매장 특정 실패 | 이름 중복으로 대상 브랜드 특정 안 됨 | P3-4-contemporary.md |
| PO-moWHxzB-j0785 | 더 캐시미어 | 컨템포러리 | 미확인 | — | thehandsome.com "the CASHMERE" — 니트·블라우스·스커트·리빙·다이닝 카테고리만 확인, 신발 언급 없음 | 캐시미어 니트 전문 | P3-4-contemporary.md |
| PO-7jzkpdw0J5009 | 데바스테 | 컨템포러리 | 미확인 | — | namu.wiki "데바스테" — 프랑스 컨템포러리 브랜드, 의류(그래픽 프린트) 위주 설명뿐 신발 정보 없음 |  | P3-4-contemporary.md |
| PO-o0iAMUwNd8494 | 로라스 블랑 | 컨템포러리 | 미확인 | — | 브랜드명으로 유의미한 검색 결과를 찾지 못함(신발 브랜드 일반 정보만 노출) |  | P3-4-contemporary.md |
| PO-ICpSlvnSS9342 | 분크 | 컨템포러리 | 미확인 | — | musinsa.com/brand/vunque, vunque.com — 가방·백팩·액세서리 위주로만 확인, 신발 정보 없음. 브랜드명(분크=VUNQUE) 매칭도 확정적이지 않음 |  | P3-4-contemporary.md |
| PO-Mnqw_jD-Q0745 | 스컬프 | 컨템포러리 | 미확인 | — | 검색 결과가 "스컬프터(SCULPTOR)"로만 나와 이 매장(스컬프)과 동일 브랜드인지 확정 못함 | 이름 매칭 불확실 | P3-4-contemporary.md |
| PO-mv3-Jggx98160 | 시리즈 코너 | 컨템포러리 | 미확인 | — | kolonfnc.com·apparelnews 등에서 이태원 편집숍(빈티지 캐주얼, 셔츠 라인, 리코드·아로마 등) 정보만 확인, 신발 취급 언급 없음 | 코오롱FnC 편집숍 | P3-4-contemporary.md |
| PO-irlPJFZOe2039 | 시스템 옴므 | 컨템포러리 | 미확인 | — | thehandsome.com SYSTEM HOMME 상품 다수 확인했으나 팬츠·재킷 등 의류만 노출, 신발 상품 직접 확인 못함 | 한섬 브랜드 — 시스템(여성)과 달리 신발 근거 미확보 | P3-4-contemporary.md |
| PO-igKO1VMCP6694 | 시프트G | 컨템포러리 | 미확인 | — | ssfshop.com SHIFT.G — 유틸리티 워크웨어 브랜드, 검색 결과는 의류 위주 |  | P3-4-contemporary.md |
| PO-tod2O9OC26870 | 아뜰리에 디 갤럭시 | 컨템포러리 | 미확인 | — | 검색 결과가 삼성물산 "GALAXY" 브랜드·아디다스 갤럭시 스니커즈로만 나와 대상 브랜드를 특정하지 못함 |  | P3-4-contemporary.md |
| PO-mh9P2LkL46463 | 아스페시 | 컨템포러리 | 미확인 | — | wconcept.co.kr, musinsa.com — 니트·의류 위주로 확인, 신발 상품 구체적 확인 안 됨 | 이탈리아 캐주얼 브랜드 | P3-4-contemporary.md |
| PO-wSmoTcuI10297 | 이비엠 | 컨템포러리 | 미확인 | — | sisun.com — "Edition By MICHAA" 여성복 브랜드로 확인, 블라우스 등 의류만 노출, 신발 정보 없음 |  | P3-4-contemporary.md |
| PO-9_zd_zpgT8064 | 타임 | 컨템포러리 | 미확인 | — | thehandsome.com TIME, dept.kr — 여성의류(스커트·자켓) 위주만 확인, 신발 상품 구체적 확인 안 됨 | 한섬 대표 브랜드지만 여성 라인 신발 근거 미확보(남성 라인 타임옴므는 확인됨) | P3-4-contemporary.md |
| PO---plE4RJq1088 | 프레이트 | 컨템포러리 | 미확인 | — | fr8ight.co.kr — 편집숍/브랜드로 추정되나 신발 취급 여부를 구체적으로 확인하지 못함(검색 결과가 물류회사 "올프레이트"와 혼재) | 이름 오염(물류회사와 혼동) | P3-4-contemporary.md |
