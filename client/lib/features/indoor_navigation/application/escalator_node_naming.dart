...
/// ```
///
/// **왜 이름을 쓰는가.** 백엔드의 수직 전이 간선은 두 층 노드를 8 m 반경 근접으로
/// 매칭하는데, 한 랜딩에 탑승 노드와 도착 노드가 1.5 m 거리로 붙어 있어 "탑승↔탑승"
/// 으로 이어질 수 있다. 라우팅 결과는 어느 쪽이든 멀쩡해 보여서 드러나지 않는다.
/// 도착 위치를 정할 때는 **이름이 유일하게 정확한 근거**이고 전이 간선은 폴백이다.
library;
