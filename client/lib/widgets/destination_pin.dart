...
/// 글리프를 못 받는다.
///
/// 증상은 실기기에서 확인했다 — **핀 도형은 그려지고 "도착" 글씨만 빠진다.**
/// 아이콘 비트맵은 글리프와 무관하게 올라가므로 빨간 핀은 멀쩡히 보이고, 그래서
/// "디자인이 반영이 안 됐다"로 읽힌다. 웹은 CJK를 시스템 폰트로 로컬 렌더해서
/// 글씨가 정상으로 나오므로 Chrome에서만 확인하면 이 차이를 절대 못 잡는다.
///
