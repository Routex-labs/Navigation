...
///
/// ## 0.18 → 0.32 (2026-08-09)
///
/// 위 실측표는 **아이콘이 5.5 논리 px이던 시절**의 값이다. 화면 배율 버그를
/// 고치면서 배지가 12~18 논리 px으로 커졌고([storeCategoryIconSizeIndoor]),
/// 같은 0.18em으로는 배지가 이름 첫 글자에 닿는다. 실기기에서 「르 라보」·「MAC」
/// 이 그렇게 나왔다. 배지가 커진 만큼 여백도 함께 키운다.
const kStoreLabelRadialOffset = 0.32;
