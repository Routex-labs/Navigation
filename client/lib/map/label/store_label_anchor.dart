...
///
/// 원본 도면은 한 폴리곤에 매장 여럿을 붙이고(31개 자리에 91개 매장) centroid가
/// 완전히 같아, 그대로 쓰면 충돌 처리가 하나만 남긴다 — 나머지는 존재하는데
/// 누를 수 없다.
///
/// 폴리곤 세로를 매장 수로 나눠 한 칸에 하나씩 놓되 **순서는 원본 핀이 정한다.**
/// 검증 기준 표는 `docs/client/map-style-rules.md` 6절.
library;
