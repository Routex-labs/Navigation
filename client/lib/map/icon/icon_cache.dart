...
///
/// 층을 바꿀 때마다 아이콘 26장을 UI 스레드에서 순차로 다시 굽고 있었다.
///
/// **키는 `addImage` 이름**(디자인을 바꾸면 이름의 버전 토큰도 바뀐다), **값이 아니라
/// Future**(두 지도가 동시에 요청해도 한 번만 돈다), **실패는 캐시하지 않는다**
/// (한 번 실패로 지도가 영구히 아이콘 없는 상태로 굳는다).
library;
