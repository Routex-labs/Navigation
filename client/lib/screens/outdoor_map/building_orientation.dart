...
///
/// 그래서 건물의 **긴 축을 화면 세로에 맞춰** 지도를 돌린다. 같은 배율에서 도면이
/// 훨씬 크게 들어오고, 폰을 든 방향과 건물 축이 나란해진다.
///
/// 화면에서 떼어 둔 이유는 **각도 계산이 부호 하나만 틀려도 조용히 90도씩
/// 어긋나서**다. 지도 컨트롤러에 묶여 있으면 그걸 테스트로 잡을 수 없다.
library;
