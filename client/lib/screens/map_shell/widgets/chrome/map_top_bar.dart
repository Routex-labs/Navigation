...
/// 지도 화면 공통 상단 바. 왼쪽 햄버거는 앱 메뉴를 열고 **모드와 무관하게 항상
/// 보인다** — 야외에서 숨기면 야외 화면에서만 닿지 않는 항목이 생긴다.
///
/// **두 얼굴을 가진다** — 평소엔 검색창 한 줄, 길찾기 중에는([routeMode]) 출발/도착
/// 두 칸. 검색과 경로 안내를 분리해야 검색이 곧바로 내비게이션을 시작하지 않는다.
///
/// **여기서 직접 입력받고** 결과는 상위의 `SearchPanel`이 바로 아래에 보여준다 —
/// 시트로 입력창을 하나 더 올리면 검색창이 두 개인 것처럼 보인다.
