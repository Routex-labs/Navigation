...
/// ## 구현 전에 정한 검증 기준
///
/// 아래 표를 먼저 쓰고 그대로 `test/domain/store_hours_test.dart`로 옮겼다.
/// 기준 규칙은 화~목 10:30–20:00 · 금~일 10:30–20:30 · 월 휴무다.
///
/// | 상황 | 입력(매장 현지) | 기대 |
/// |---|---|---|
/// | 영업 중 | 화 14:00 | 영업 중 · 다음 전환 화 20:00 |
/// | 개점 전 | 화 09:00 | 영업 종료 · 다음 전환 화 10:30 |
/// | 폐점 후 | 화 21:00 | 영업 종료 · 다음 전환 수 10:30 |
/// | 개점 정각 | 화 10:30 | 영업 중 (개점 시각은 포함) |
/// | 폐점 정각 | 화 20:00 | 영업 종료 (폐점 시각은 제외) |
/// | 브레이크 타임 안 | 15:00 / 11–14 · 17–21 | 영업 종료 · 다음 전환 17:00 |
/// | 브레이크 타임 전 | 12:00 / 같은 규칙 | 영업 중 · 다음 전환 14:00 |
/// | 자정 넘김 | 수 01:00 / 화 22:00–02:00 | 영업 중 · 다음 전환 수 02:00 |
/// | 자정 넘김 끝 | 수 02:00 | 영업 종료 |
/// | 요일 휴무 | 월 12:00 | 영업 종료 · 다음 전환 화 10:30 |
/// | 예외 휴점 | 예외{9/17 휴무}의 12:00 | 영업 종료 · 다음 전환 9/18 |
/// | 예외 단축 | 예외{9/18 10:30–18:00}의 19:00 | 영업 종료 (요일 규칙이면 열려 있었다) |
/// | 종일 영업 | 매일 00:00–24:00 | 영업 중 · 다음 전환 없음 |
/// | 전 요일 휴무 | 아무 시각 | 영업 종료 · 다음 전환 없음 |
/// | 낡은 데이터 | 확인일 91일 전 | 판정 없음(unknown) · isStale |
/// | 임계값 정각 | 확인일 90일 전 | 판정 정상 |
/// | 다른 시간대 기기 | UTC 04:00 · 오프셋 540 | 매장 13:00으로 판정 |
library;
