...
///
/// 그래도 **양 끝과 높이는 안다** — 어느 노드에서 탔고, 어느 노드로 내리고, 지금까지
/// 몇 미터를 오르내렸는지. 그래서 마커는 두 점 사이를 **기압 진행률**로 흐른다
/// ([escalatorRideProgressTarget]). 고정 2.4초는 실제 탑승(20~35초)보다 한참 짧아
/// "점이 끝까지 안 내려온다"로 보였다. 기압으로 흘리면 서 있든 걷든 **몸이 시간을
/// 정하고**, 점이 끝에 닿는 순간이 곧 하차 확정 순간이다.
library;
