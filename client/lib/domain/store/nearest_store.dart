...
///
/// - **[reachByNodeId]가 null이거나 비었을 때.** [reach]는 null로 두되,
///   **[currentFloorId]와 같은 층이 있으면 그 매장을 대표로 고른다.** 그마저 없으면
///   입력 첫 번째다.
/// - **일부만 도달 가능할 때.** **도달 가능한 것 중 최근접**을 고른다 — 도달 못 하는
///   곳을 "가장 가깝다"고 적지 않는다.
/// - **전원 도달 불가일 때.** 입력 첫 번째 + [reach] null.
///
