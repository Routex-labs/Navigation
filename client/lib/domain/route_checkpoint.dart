...
class RouteCheckpointShadowTracker {
  ...
  List<RouteCheckpointEvent> apply({
    ...
    required CorridorTrackingResult tracker,
    required FloorGraph graph,
    ...
    final distanceM =
        ((step.actualMarkerPosition ?? tracker.previewPosition) -
  ...
  String? _gateFailure({
    ...
    if (tracker.state == CorridorTrackingState.uncertain) return 'uncertain';
