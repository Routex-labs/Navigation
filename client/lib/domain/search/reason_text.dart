...
///
/// 서버 `reason`은 질의 전체의 근거와 매장별 근거를 이어 붙인 것이라, 목록으로 놓으면
/// 앞 문장이 행마다 똑같아 정보량 0으로 **층이 있던 자리**를 밀어낸다.
///
/// **서버 쪽에서 빼지 않는다** — 한 건만 떼어 봐도 근거가 서야 한다는 계약이고,
/// 무엇이 겹치는지는 여러 행을 함께 보는 **화면만 아는 사실**이다.
library;
