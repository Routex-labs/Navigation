...
///
/// 실내(floor_plan_view.dart)와 야외(outdoor_map_screen.dart)가 같은 지점을
/// 봤을 때 마커가 달라 보이면 안 되므로 같은 그림을 쓴다. 예전에는 같은 렌더
/// 코드가 두 파일에 한 벌씩 있었고, 주석으로 "바꿀 땐 함께 맞춰야 한다"고
/// 서로를 가리키고 있었다 — 그 약속을 코드로 옮긴 것이 이 파일이다.
///
