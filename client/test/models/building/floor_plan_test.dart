  ...
  group('FloorPlan.approximateCurrentLocation', () {
    test('prefers the footprint centroid when available', () {
      final floorPlan = FloorPlan(
        footprint: const [LatLng(37.0, 127.0), LatLng(38.0, 129.0)],
        corridors: const [
          [LatLng(1.0, 1.0)],
        ],
    ...
    test(
      'falls back to the first corridor point when there is no footprint',
      () {
        final floorPlan = FloorPlan(
          corridors: const [
    ...
    test(
      'falls back to the first POI when there is no footprint or corridor',
      () {
        final floorPlan = FloorPlan(
